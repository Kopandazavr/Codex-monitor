...
public final class NowBarManager {
    static final String ACTION_END = "dev.kopandazavr.codexmonitor.action.NOW_BAR_END";
    static final String ACTION_REFRESH = "dev.kopandazavr.codexmonitor.action.NOW_BAR_REFRESH";
    ...
    private static final String PREFS = "codex_monitor_now_bar_v1";
