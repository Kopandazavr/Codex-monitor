...
public final class OAuthService extends Service {
            ...
            while (!cancelled) {
                ...
                if (!secureEquals(pkce.state, callback.parameters.get("state"))) {
                    ...
                    writeBrowser(browser, 400,
                            "The sign-in state did not match. Return to Codex Monitor and try again.", false);
                    closeQuietly(browser);
                    browser = null;
                    continue;
                }
                ...
                try {
                    writeBrowser(browser, 200,
                            "Your ChatGPT account is connected. Returning to Codex Monitor…", true);
    ...
    private Notification buildNotification(String text, String authUrl) {
        ...
        return new Notification.Builder(this, CHANNEL_ID)
                ...
                .setContentTitle("Codex Monitor sign-in")
                .setContentText(text)
