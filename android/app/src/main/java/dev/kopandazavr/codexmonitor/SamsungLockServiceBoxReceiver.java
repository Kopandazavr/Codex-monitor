...
public final class SamsungLockServiceBoxReceiver extends BroadcastReceiver {
    ...
    private static final Entry[] ENTRIES = {new Entry("codex_monitor_numbers_square", SamsungLockWidgetSupport.Shape.SQUARE, SamsungLockWidgetSupport.Style.NUMBERS), new Entry("codex_monitor_numbers_wide", SamsungLockWidgetSupport.Shape.WIDE, SamsungLockWidgetSupport.Style.NUMBERS), new Entry("codex_monitor_rings_square", SamsungLockWidgetSupport.Shape.SQUARE, SamsungLockWidgetSupport.Style.RINGS), new Entry("codex_monitor_rings_wide", SamsungLockWidgetSupport.Shape.WIDE, SamsungLockWidgetSupport.Style.RINGS), new Entry("codex_monitor_dials_square", SamsungLockWidgetSupport.Shape.SQUARE, SamsungLockWidgetSupport.Style.DIALS), new Entry("codex_monitor_dials_wide", SamsungLockWidgetSupport.Shape.WIDE, SamsungLockWidgetSupport.Style.DIALS), new Entry("codex_monitor_bars_square", SamsungLockWidgetSupport.Shape.SQUARE, SamsungLockWidgetSupport.Style.BARS), new Entry("codex_monitor_bars_wide", SamsungLockWidgetSupport.Shape.WIDE, SamsungLockWidgetSupport.Style.BARS)};
    ...
    private static void send(Context context, Entry entry) {
        try {
            ...
            Log.w("CodexMonitorLock", "ServiceBox response failed", e);
        }
    }
