...
public final class Ui {
    ...
    public static Spinner spinner(final Context context, String[] strArr, final boolean z) {
        ...
        spinner.setAdapter((SpinnerAdapter) new ArrayAdapter<String>(context, android.R.layout.simple_spinner_item, strArr) { // from class: dev.kopandazavr.codexmonitor.Ui.1
    ...
    public static void configureSystemBars(Activity activity, View view, boolean z) {
        ...
        if (Build.VERSION.SDK_INT >= 30) {
            ...
            view.setOnApplyWindowInsetsListener(new View.OnApplyWindowInsetsListener() { // from class: dev.kopandazavr.codexmonitor.Ui.2
