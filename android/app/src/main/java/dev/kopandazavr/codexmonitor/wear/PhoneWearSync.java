...
import dev.kopandazavr.codexmonitor.AppPreferences;
import dev.kopandazavr.codexmonitor.DiagnosticLog;
import dev.kopandazavr.codexmonitor.NowBarManager;
import dev.kopandazavr.codexmonitor.NowBarPreferences;
import dev.kopandazavr.codexmonitor.RefreshScheduler;
import dev.kopandazavr.codexmonitor.SecureTokenStore;
import dev.kopandazavr.codexmonitor.UsageSnapshot;
import dev.kopandazavr.codexmonitor.UsagePacePreferences;
...
public final class PhoneWearSync {
    ...
    private static final String PREFS = "codex_monitor_wear_sync_v1";
