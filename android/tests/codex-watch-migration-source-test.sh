...
# 2.16 is the current bounded phone-follow-up release and stays aligned on phone/Wear.
grep -Fq 'versionName = "2.16.0"' "$APP_GRADLE"
grep -Fq 'versionCode = 42' "$APP_GRADLE"
grep -Fq 'versionName = "2.16.0"' "$WEAR_GRADLE"
grep -Fq 'versionCode = 42' "$WEAR_GRADLE"
