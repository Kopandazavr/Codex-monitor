...
# Current 2.15 code-bearing candidate identity.
grep -Fq 'versionCode = 41' "$ROOT/app/build.gradle.kts"
grep -Fq 'versionName = "2.15.0"' "$ROOT/app/build.gradle.kts"
grep -Fq 'versionCode = 41' "$ROOT/wear/build.gradle.kts"
grep -Fq 'versionName = "2.15.0"' "$ROOT/wear/build.gradle.kts"
grep -Fq 'VERSION_CODE = 41' "$SRC/AppConstants.java"
grep -Fq 'VERSION_NAME = "2.15.0"' "$SRC/AppConstants.java"
...
echo 'Codex Monitor 2.15.0 scoped source contract PASS'
