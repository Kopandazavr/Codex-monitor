...
grep -Fq 'versionCode = 48' "$ROOT/app/build.gradle.kts"
grep -Fq 'versionName = "2.22.0"' "$ROOT/app/build.gradle.kts"
grep -Fq 'VERSION_CODE = 48' "$SRC/AppConstants.java"
grep -Fq 'VERSION_NAME = "2.22.0"' "$SRC/AppConstants.java"
...
grep -Fq 'toolbar.setSubtitle(identity)' "$SRC/SettingsActivity.java"
