...
import dev.kopandazavr.codexmonitor.wear.WearSyncPaths;
import java.util.Collections;

public final class WearOngoingMonitor {
    public static final String ACTION_REFRESH = "dev.kopandazavr.codexmonitor.action.WEAR_REFRESH";
    public static final String ACTION_STOP = "dev.kopandazavr.codexmonitor.action.WEAR_STOP";
