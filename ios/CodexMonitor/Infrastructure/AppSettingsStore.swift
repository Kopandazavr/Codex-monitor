...
public final class AppSettingsStore: ObservableObject {
    public static let storageKey = "codex-monitor.app-settings-v1"
...
final class RefreshEngagementStore {
    private static let foregroundKey = "codex-monitor.refresh-foreground-at-v1"
    private static let lastOpenKey = "codex-monitor.refresh-last-open-at-v1"
    private static let scoreKey = "codex-monitor.refresh-attention-score-v1"
    private static let scoreDateKey = "codex-monitor.refresh-attention-score-date-v1"
    private static let failuresKey = "codex-monitor.refresh-failures-v1"
