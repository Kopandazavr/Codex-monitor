...
enum DiagnosticLog {
    static let unlockKey = "codex-monitor.diagnostics-unlocked-v1"
    private static let enabledKey = "codex-monitor.diagnostics-enabled-v1"
    private static let sessionKey = "codex-monitor.diagnostics-session-v1"
    ...
    static func exportURL() throws -> URL {
        ...
        let export = FileManager.default.temporaryDirectory
            .appendingPathComponent("codex-monitor-diagnostics.jsonl")
