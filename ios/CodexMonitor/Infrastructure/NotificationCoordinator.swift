...
nonisolated public enum NotificationDeduplication {
    public static let identifierPrefix = "codex-monitor."
    public static let expiryIdentifierPrefix = "codex-monitor.credit-expiry."
    public static let refillIdentifierPrefix = "codex-monitor.refill."
    public static let routeUserInfoKey = "codexmonitor.route"
...
public actor NotificationCoordinator {
    private static let knownCreditCountKey = "codex-monitor.notification.known-credit-count"
    private static let lowUsageStatePrefix = "codex-monitor.notification.low-window."
    private static let creditExpiryAnnouncedKey = "codex-monitor.notification.credit-expiry-announced"
    private static let userResetFiveHourUntilKey = "codex-monitor.notification.user-reset-five-hour-until"
    private static let userResetWeeklyUntilKey = "codex-monitor.notification.user-reset-weekly-until"
    private static let userResetMonthlyUntilKey = "codex-monitor.notification.user-reset-monthly-until"
    private static let categoriesRegisteredKey = "codex-monitor.notification.categories-registered"
    ...
    public func sendTestNotification() async throws -> Bool {
        ...
        content.title = "Codex Monitor notifications are working"
    ...
    private func processWindow(
        ...
        resetContent.body = "Your \(label.lowercased()) allowance should be available again. Open Codex Monitor to refresh."
