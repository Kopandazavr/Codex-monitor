...
/// CodexMonitorCore. This API cannot persist tokens or arbitrary app cache data.
public actor WidgetSnapshotCache {
    public nonisolated static let appGroupIdentifier = "group.dev.kopandazavr.codexmonitor"
