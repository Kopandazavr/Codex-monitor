...
nonisolated public struct CodexBackendConfiguration: Sendable, Equatable {
    ...
    public nonisolated init(
        ...
        originator: String = "codex-monitor-ios"
    ) {
...
public actor LiveCodexService: CodexService {
    ...
    public func signOut() async {
        ...
        BGTaskScheduler.shared.cancel(taskRequestWithIdentifier: "dev.kopandazavr.codexmonitor.refresh")
        WidgetCenter.shared.reloadAllTimelines()
    }
    ...
    private func sendBackendRequest(
        ...
        request.setValue("codex-monitor-ios/2.8.0", forHTTPHeaderField: "User-Agent")
