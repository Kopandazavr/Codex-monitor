...
public enum CodexMonitorParsingError: Error, Sendable, Equatable {
    case invalidRootObject
}

extension CodexMonitorParsingError: LocalizedError {
...
enum JSONSupport {
    ...
    static func object(from data: Data) throws -> Object {
        ...
        guard let object = value as? Object else {
            throw CodexMonitorParsingError.invalidRootObject
        }
        return object
    }
