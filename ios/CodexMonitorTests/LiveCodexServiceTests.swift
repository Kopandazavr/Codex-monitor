...
final class LiveCodexServiceTests: XCTestCase {
    func testRefreshSendsHeadersAndRetriesExactlyOnceAfterUnauthorized() async throws {
        CodexMonitorURLProtocol.reset()
        defer { CodexMonitorURLProtocol.reset() }
        ...
        CodexMonitorURLProtocol.configure { request in
            ...
            case "/backend-api/wham/usage":
                XCTAssertEqual(request.value(forHTTPHeaderField: "originator"), "codex-monitor-ios")
    ...
    func testUsageRefreshRetainsCacheWhenNetworkFails() async throws {
        ...
        CodexMonitorURLProtocol.configure { _ in
    ...
    func testResetPreflightFailurePropagatesWithoutUsableCachedCredit() async throws {
        ...
        XCTAssertFalse(CodexMonitorURLProtocol.requests.contains {
