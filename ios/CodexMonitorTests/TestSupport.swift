...
final class CodexMonitorURLProtocol: URLProtocol, @unchecked Sendable {
...
func makeStubbedSession() -> URLSession {
    ...
    configuration.protocolClasses = [CodexMonitorURLProtocol.self]
...
func temporaryFileURL(_ name: String = UUID().uuidString) -> URL {
    FileManager.default.temporaryDirectory
        .appendingPathComponent("CodexMonitorTests-\(name)")
}
