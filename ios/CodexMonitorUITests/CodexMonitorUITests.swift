...
@MainActor
final class CodexMonitorUITests: XCTestCase {
    ...
    func testDemoDashboardAndSettings() throws {
        ...
        XCTAssertTrue(app.navigationBars["Codex Monitor"].waitForExistence(timeout: 5))
    ...
    func testEditDashboardVisibilityControlsIncludeLaterReleaseSections() throws {
        ...
        XCTAssertTrue(app.navigationBars["Codex Monitor"].waitForExistence(timeout: 3))
