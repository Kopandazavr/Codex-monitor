...
struct FiveHourAccessoryWidget: Widget {
    static let kind = "CodexMonitor.Accessory.FiveHour"
...
struct WeeklyAccessoryWidget: Widget {
    static let kind = "CodexMonitor.Accessory.Weekly"
...
struct DualAllowanceAccessoryWidget: Widget {
    static let kind = "CodexMonitor.Accessory.Dual"
    ...
    var body: some View {
        if snapshot.mode == .signedOut {
            Image(systemName: "person.crop.circle.badge.exclamationmark")
                .font(.title2)
                .widgetURL(URL(string: "codexmonitor://dashboard"))
                .accessibilityLabel("Sign in to Codex Monitor")
        } else {
...
private struct DualAccessoryUsageView: View {
    ...
    var body: some View {
        if snapshot.mode == .signedOut {
            Label("Open Codex Monitor to sign in", systemImage: "person.crop.circle")
                .widgetURL(URL(string: "codexmonitor://dashboard"))
