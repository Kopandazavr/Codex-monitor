...
enum WidgetTapAction: String, AppEnum, Sendable {
    ...
    var url: URL {
        switch self {
        case .open:
            URL(string: "codexmonitor://dashboard")!
        case .refresh:
            URL(string: "codexmonitor://refresh")!
        case .reset:
            URL(string: "codexmonitor://reset")!
        }
    }
}

struct MeterWidgetConfigurationIntent: WidgetConfigurationIntent, Sendable {
    static let title: LocalizedStringResource = "Configure Codex Monitor"
